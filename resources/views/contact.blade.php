                ...
                <div class="row">
                    <div class="col">
                        <form  class="w-100" action="contact" method="post">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <input type="text" id="name" required="" name="name" class="form-control bg-gray mb-3" placeholder="Your Name*">
                                    <input type="text" id="email" required="" name="email" class="form-control bg-gray mb-3" placeholder="Email Address*">
                                   <!--  <input type="text" id="site-link" name="site-link" class="form-control bg-gray mb-3" placeholder="Website"> -->
                                    <input type="text" id="subject" required="" name="subject" class="form-control bg-gray mb-3" placeholder="Subject">
                                </div>
                                <div class="col-lg-6">
                                    <textarea id="message" required="" name="message" class="form-control bg-gray mb-3" rows="5" placeholder="Type Comments..."></textarea>
                                </div>
