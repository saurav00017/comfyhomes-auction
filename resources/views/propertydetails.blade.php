                ...
                <div class="col-xxl-8 col-lg-7">
                    <div class="property-page-single">
                        <div class="page-content">
                            ...
                            <p style="line-height: 1px; margin-bottom: 6%;">{{$property->possession}}</p>
                            <ul class="property-grid-list">
                                ...
                                <li>
                                    ...
                                    <div class="property-grid-list-details">
                                        ...
                                        <p class="property-grid-list-text">{{$property->no_of_floor}}</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="property-grid-list-icon">
                                    ...
                                    <div class="property-grid-list-details">
                                        ...
                                        <p class="property-grid-list-text">{{$property->no_of_towers}}</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="property-grid-list-icon">
                                    ...
                                    <div class="property-grid-list-details">
                                        ...
                                        <p class="property-grid-list-text">{{$property->no_of_lifts}}</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="property-grid-list-icon">
                                ...
                                <li>
                                 ...
                                 <li>
                                    ...
                                    <div class="property-grid-list-details">
                                        ...
                                        <p class="property-grid-list-text">{{$property->flat_type}}</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="property-grid-list-icon">
                                ...
                                <li>
                                    ...
                                    <div class="property-grid-list-details">
                                        ...
                                        <p class="property-grid-list-text">{{$property->no_of_blacony}}</p>
                                    </div>
                                </li>
