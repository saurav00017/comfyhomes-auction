				...
				<div class="main-sidebar-body" >
					<ul class="nav">
						...
						<li class="nav-item" id="l4">
							<a class="nav-link" href="{{config('app.baseURL')}}/admin/user-management"><i class="fe fe-box"></i><span class="sidemenu-label">User</span></a>
						</li>
						 <li class="nav-item" id="l24">
							<a class="nav-link" href="{{config('app.baseURL')}}/admin/category-management"><i class="fe fe-box"></i><span class="sidemenu-label">Category</span></a>
						</li> 						<li class="nav-item" id="l9">
							<a class="nav-link" href="{{config('app.baseURL')}}/admin/subscription-management"><i class="fe fe-box"></i><span class="sidemenu-label">Subscription</span></a>
						</li>
						<li class="nav-item" id="l3">
							<a class="nav-link" href="{{config('app.baseURL')}}/admin/notice-management"><i class="fe fe-box"></i><span class="sidemenu-label">Notice</span></a>
						</li>
						<li class="nav-item" id="l3">
							<a class="nav-link" href="{{config('app.baseURL')}}/admin/advertising-management"><i class="fe fe-box"></i><span class="sidemenu-label">Advertising</span></a>
						</li>
						
						<li class="nav-item" id="l6">
							<a class="nav-link" href="{{config('app.baseURL')}}/admin/auction-management

							"><i class="fe fe-box"></i><span class="sidemenu-label">Auction</span></a>
						</li> 

						<li class="nav-item" id="l6">
							<a class="nav-link" href="{{config('app.baseURL')}}/admin/bank-management
