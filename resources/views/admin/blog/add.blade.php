							...
							<div class="card custom-card">
								<div class="card-body">
									...
									<div>
										...
										<h6 class="card-title mb-1">Create Blog Form</h6>
										<!-- <p class="text-muted card-sub-title">A form group layout for entering card information upon checkout.</p> -->

									</div>
									<hr>

							<form class="form-horizontal" role="form" method="POST" action="create-blog" enctype="multipart/form-data" >
																															@csrf
										...
										<div class="col-md-12 col-lg-12 col-xl-12" style="margin-top: 14px;">
											<div class="">
												...
												<div class="form-group">
													...
													<input class="form-control" name="title" required="" type="text" placeholder="Enter Title Name">
												</div>
