...
<body>
	<div class="container-fluid">
					...
					<div class="page-header">
						<div>
							<h2 class="main-content-title tx-24 mg-b-5">Blog Form</h2>
							<ol class="breadcrumb">
							...
							<div class="card custom-card">
								<div class="card-body">
									...
									<div>
										...
										<h6 class="card-title mb-1">Update Blog Form</h6>
										<!-- <p class="text-muted card-sub-title">A form group layout for entering card information upon checkout.</p> -->

									</div>
									<hr>

							<form class="form-horizontal" role="form" method="POST" action="{{config('app.baseURL')}}/admin/update-blog/{{$blog->id}}" enctype="multipart/form-data" >
																															@csrf
										...
										<div class="col-md-12 col-lg-12 col-xl-12" style="margin-top: 14px;">
											<div class="">
												...
												<div class="form-group">
													...
													<div class="img-wrap">
                             <img class="image-size slider-img"  src="{{config('app.baseURL')}}/storage/app/{{$blog->image}}" alt="" style="height: 100px;">&nbsp;
                          </div>
                          @if($blog->image!="")
												...
												<div class="form-group">
													...
													<input class="form-control" name="title" required="" type="text" placeholder="Enter Title Name" value="{{$blog->title}}">
												</div>

												<div class="form-group">
													<label class="" >Description:</label><sup style="color: red;">*</sup>
													<input class="form-control" name="description" required="" type="text" placeholder="Enter Description" value="{{$blog->description}}">
												</div>
