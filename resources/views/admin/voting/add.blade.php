							...
							<div class="card custom-card">
								<div class="card-body">
									...
									<div>
										...
										<h6 class="card-title mb-1">Create Voting Form</h6>
										<!-- <p class="text-muted card-sub-title">A form group layout for entering card information upon checkout.</p> -->

									</div>
									<hr>

														<form class="form-horizontal" role="form" method="POST" action="create-voting" enctype="multipart/form-data" >
																															@csrf
										...
										<div class="col-md-12 col-lg-12 col-xl-12" style="margin-top: 14px;">
											<div class="">
                                              ...
                                              <select class="form-control" name="voting_type" id="category">
                                                 ...
                                                 <option value="1">IBC Voting</option>
                                                 <option value="2">Association Voting</option>
                                                 <option value="3">Housing Society Voting</option>
                                                 <option value="4">NGO Voting</option>
                                                 <option value="5">AGM Voting</option>
												...
												<div class="form-group">
													...
													<input class="form-control" name="question" required="" type="text" placeholder="Enter Question">
												</div>

												<div class="form-group">
													<label class="" >Answer:</label><sup style="color: red;">*</sup>
													<input class="form-control" name="answer" required="" type="text" placeholder="Enter Answer">
												</div>
