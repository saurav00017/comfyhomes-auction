  ...
  <div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
      <div class="row breadcrumbs-top">
        <div class="col-12">
           <h4 class="card-title" style="color:  #880808;">All Voting</h4>
  ...
  <div class="row">
    <div class="col-12" >
      <div class="card">
        ...
        <a href="{{config('app.baseURL')}}/admin/create-voting"> <button type="submit" class="btn pull-right btn btn-primary panel-button add-btn" >Create Voting</button></a><br>
...
$(document).ready( function () {
    var table = $('#data-table').DataTable({
        ...
        serverSide: true,
        order: [[0, 'desc']],
        ajax: "{{config('app.baseURL')}}/admin/voting-management-allData",
        columns: [
        
 {
        ...
        return meta.row + meta.settings._iDisplayStart + 1;
         ...
         {"targets":-1,
             ...
             if(row.voting_type==1){
             return "<span>IBC Voting</sapn>";
              
            }
            if(row.voting_type==2){
             return "<span>Association Voting</sapn>";
              
            }
            if(row.voting_type==3){
             return "<span>Housing Society Voting</sapn>";
              
            }
            if(row.voting_type==3){
             return "<span>NGO Voting</sapn>";
              
            }
            if(row.voting_type==3){
             return "<span>AGM Voting</sapn>";
          ...
          {"targets":-1,
             ...
             if(row.question!='' && row.question!=null && row.question!='undefined'){           
        ...
        {"targets":-1,
             ...
             if(row.answer!='' && row.answer!=null && row.answer!='undefined'){           
             ...
             "mRender": function(data, type, row) {
             if(row.is_active==0){
             return "<a class=datatable-left-link href={{config('app.baseURL')}}/admin/active-voting/" + row.id+"><span><button type='submit' class='btn btn-success'>Active</button></span></a>";
              
            }
            else{
               return "<a class=datatable-left-link href={{config('app.baseURL')}}/admin/inactive-voting/" + row.id+"><span><button type='submit' class='btn btn-danger'>InActive</button></span></a>";
               }
            },
          },
