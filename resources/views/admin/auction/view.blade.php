                ...
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ config('app.baseURL') }}/admin/dashboard">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a
                                        href="{{ config('app.baseURL') }}/admin/auction-management">Auctions</a></li>
            ...
            <section class="card">
                <div class="card-header">
                    ...
                    <div class="heading-elements">
                        <a href="{{ config('app.baseURL') }}/admin/edit-auction/{{ $auction->id }}"
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-4">
                            <p><strong>Property Type:</strong> {{ $auction->categories->name ?? 'N/A' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <h5 class="section-title">Borrower Information</h5>
                            <hr>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <p><strong>Borrower Name:</strong> {{ $auction->borrower_name }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-24">
                        <div class="col-12">
                            <h5 class="section-title">Bank Contact Details</h5>
                            <hr>
                        </div>

                        <div class="col-md-6 col-lg-3 mb-3">
                            <p class="mb-1"><strong>Branch Address:</strong></p>
                            <p>{{ $auction->branch_address ?? 'N/A' }}</p>
                        </div>

                        <div class="col-md-6 col-lg-3 mb-3">
                            <p class="mb-1"><strong>Contact Person:</strong></p>
                            <p>{{ $auction->bank_contact_name ?? 'N/A' }}</p>
                        </div>

                        <div class="col-md-6 col-lg-3 mb-3">
                            <p class="mb-1"><strong>Contact Email:</strong></p>
                            <p>
                                @if ($auction->bank_contact_email)
                                    <a
                                        href="mailto:{{ $auction->bank_contact_email }}">{{ $auction->bank_contact_email }}</a>
                                @else
                                    N/A
                                @endif
                            </p>
                        ...
                        <div class="col-md-6 col-lg-3 mb-3">
                            ...
                            <p>
                                @if ($auction->bank_contact_phone)
                                    <a
                                        href="tel:{{ $auction->bank_contact_phone }}">{{ $auction->bank_contact_phone }}</a>
                                @else
                                    N/A
                                @endif
                            </p>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-4">
                            <p><strong>EMD Submission:</strong>
                                {{ date('d M Y h:i A', strtotime($auction->emd_submission)) }}</p>
                        </div>
                        <div class="col-md-4">
                            <p><strong>Start Date/Time:</strong>
                                {{ date('d M Y h:i A', strtotime($auction->auction_start_datetime)) }}</p>
                        </div>
                        <div class="col-md-4">
                            <p><strong>End Date/Time:</strong>
                                {{ date('d M Y h:i A', strtotime($auction->auction_end_datetime)) }}</p>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    @if ($auction->thumbnail)
                                        <img src="{{ Storage::url($auction->thumbnail) }}" class="img-fluid"
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    @if ($auction->document)
                                        <a href="{{ Storage::url($auction->document) }}" target="_blank"
