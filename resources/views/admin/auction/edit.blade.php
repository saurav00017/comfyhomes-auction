					...
					<div class="row">
						<div class="col-lg-12 col-md-12">
							<div class="card custom-card">
								...
								<form class="form-horizontal" role="form" method="POST" action="{{config('app.baseURL')}}/admin/update-auction/{{$auction->id}}" enctype="multipart/form-data" >
																															@csrf
									...
									<div class="row">
										<div class="col-md-12 col-lg-12 col-xl-12" style="margin-top: 14px;">
										    ...
										    <div class="form-group">
								              ...
								              <option value="{{$banks->id}}" <?php if ($auction->bank_name == $banks->id) echo "selected"; ?>>{{$banks->bank_name}}</option>
								              @endforeach
								              </select>
                                            </div>
												...
												<div class="form-group">
													...
													<input class="form-control" name="state" required="" type="text" placeholder="Enter State"value="{{$auction->state}}">
												</div>

												<div class="form-group">
													<label class="" >District:</label><sup style="color: red;">*</sup>
													<input class="form-control" name="district" required="" type="text" placeholder="Enter City" value="{{$auction->district}}">
												</div>

												<div class="form-group">
													<label class="" >Locality:</label><sup style="color: red;">*</sup>
													<input class="form-control" name="locality" required="" type="text" placeholder="Enter Locality" value="{{$auction->locality}}">
												</div>
                        ...
                        <div class="form-group">
													...
													<input class="form-control" name="area" required="" type="text" placeholder="Enter Area Sq.Ft" value="{{$auction->area}}">
												</div>
												

												<div class="form-group">
													<label class="" >Property Category:</label><sup style="color: red;">*</sup>
													<input class="form-control" name="property_type" required="" type="text" placeholder="Enter Property Type" value="{{$auction->property_type}}">
												</div>

												<div class="form-group">
													<label class="" >Property Type:</label><sup style="color: red;">*</sup>
													<input class="form-control" name="property_type_one" type="text" required=""  placeholder="Enter Property Type" value="{{$auction->property_type_one}}">
												</div>

												<div class="form-group">
													<label class="" >Property Price:</label><sup style="color: red;">*</sup>
													<input class="form-control" name="property_price" required="" type="number" onkeypress="if(this.value.length==10)" placeholder="Enter Property Price" value="{{$auction->property_price}}">
												</div>

												<div class="form-group">
													<label class="" >Reserve Price:</label><sup style="color: red;">*</sup>
													<input class="form-control" name="reserve_price" required="" type="number" onkeypress="if(this.value.length==10)" placeholder="Enter Reserve Price" value="{{$auction->reserve_price}}">
												</div>

												<div class="form-group">
													<label class="" >Market Price:</label><sup style="color: red;">*</sup>
													<input class="form-control" name="market_price" type="number" onkeypress="if(this.value.length==10)" required=""  placeholder="Enter Market Price" value="{{$auction->market_price}}">
												</div>


												<div class="form-group">
													<label class="" >Emd Amount:</label><sup style="color: red;">*</sup>
													<input class="form-control" name="emd_amount" required="" type="number" onkeypress="if(this.value.length==10)" placeholder="Enter Emd Amount" value="{{$auction->emd_amount}}">
												</div>

												<div class="form-group">
													<label class="" >Bid Increment:</label><sup style="color: red;">*</sup>
													<input class="form-control" name="bid_increment" required="" type="number" onkeypress="if(this.value.length==10)" placeholder="Enter Bid Increment" value="{{$auction->bid_increment}}">
												</div>

												<div class="form-group">
													<label class="" >Emd Submission:</label><sup style="color: red;">*</sup>
													<input class="form-control" name="emd_submission" required="" type="datetime-local" placeholder="Enter Emd Submission" value="{{$auction->emd_submission}}">
												</div>

                        <div class="form-group">
													<label class="" >Auction Start Date Time:</label><sup style="color: red;">*</sup>
													<input class="form-control" name="auction_start_datetime" required="" type="datetime-local" placeholder="Enter Auction Start Date Time" value="{{$auction->auction_start_datetime}}">
												</div>

												<div class="form-group">
													<label class="" >Auction Start Date Time:</label><sup style="color: red;">*</sup>
													<input class="form-control" name="auction_end_datetime" required="" type="datetime-local" placeholder="Enter Auction Start Date Time" value="{{$auction->auction_end_datetime}}">
												</div>
