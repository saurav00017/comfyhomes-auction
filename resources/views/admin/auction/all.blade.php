            ...
            var table = $('#data-table').DataTable({
                ...
                columns: [
...

                    {
                        ...
                        "ilter": false,
                        "mRender": function(data, type, row) {
                            return "<a class=datatable-left-link href={{ config('app.baseURL') }}/admin/update-auction/" +
                                row.id +
                                "><span><button type='submit' class='btn btn-primary mr-1'>Update</button></span></a><a class=datatable-left-link href={{ config('app.baseURL') }}/admin/delete-auction/" +
                                row.id +
