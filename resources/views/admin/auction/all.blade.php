  ...
  <div class="row">
    <div class="col-12" >
      <div class="card">
        ...
        <a href="{{config('app.baseURL')}}/admin/create-auction"> <button type="submit" class="btn pull-right btn btn-primary panel-button add-btn" >Create Auction</button></a><br>
...
$(document).ready( function () {
        ...
        
 {
       ...
       {"targets":-1,
             ...
             "mRender": function(data, type, row) {
             if(row.is_active==0){
             return "<a class=datatable-left-link href={{config('app.baseURL')}}/admin/active-auction/" + row.id+"><span><button type='submit' class='btn btn-success'>Active</button></span></a>";
              
            }
            else{
               return "<a class=datatable-left-link href={{config('app.baseURL')}}/admin/inactive-auction/" + row.id+"><span><button type='submit' class='btn btn-danger'>InActive</button></span></a>";
               }
            },
          },
