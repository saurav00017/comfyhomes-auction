  ...
  <div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
      <div class="row breadcrumbs-top">
        <div class="col-12">
           <h4 class="card-title" style="color:  #880808;">All Amenity</h4>
  ...
  <div class="row">
    <div class="col-12" >
      <div class="card">
        ...
        <a href="{{config('app.baseURL')}}/admin/ameneties-create" > <button type="submit" class="btn pull-right btn btn-primary panel-button add-btn">Create Amenity</button></a><br>
...
$(document).ready( function () {
    var table = $('#data-table').DataTable({
        ...
        serverSide: true,
        order: [[0, 'desc']],
        ajax: "{{config('app.baseURL')}}/admin/ameneties-management-allData",
        columns: [
        ...
        return meta.row + meta.settings._iDisplayStart + 1;
           ...
           {"targets":-1,
             ...
             if(row.is_active==0){
              ...
              return "<a class=datatable-left-link href={{config('app.baseURL')}}/admin/active-ameneties/" + row.id+"><span><button type='submit' class='btn btn-success'>Activate</button></span></a>";
              ...
              return "<a class=datatable-left-link href={{config('app.baseURL')}}/admin/inactive-ameneties/" + row.id+"><span><button type='submit' class='btn btn-danger'>InActivate</button></span></a>";
               }
            },
          },
             ...
             "ilter":false,
             "mRender": function(data, type, row){
              return "<a class=datatable-left-link href={{config('app.baseURL')}}/admin/update-ameneties/" + row.id+"><span><button type='submit' class='btn btn-success mr-1'>Update</button></span></a> <a class=datatable-left-link href={{config('app.baseURL')}}/admin/delete-ameneties/" + row.id+"><span><button type='submit' class='btn btn-danger mr-1'>Delete</button></span></a>";
