...
<body>
							...
							<div class="card custom-card">
								<div class="card-body">
									...
									<div>
										...
										<h6 class="card-title mb-1">Create Notice Form</h6>
										<!-- <p class="text-muted card-sub-title">A form group layout for entering card information upon checkout.</p> -->

									</div>
									<hr>

					<form class="form-horizontal" role="form" method="POST" action="create-notice" enctype="multipart/form-data" >
						@csrf
 ...
 -->
   ...
   <div class="form-group">
													...
													<input class="form-control" name="column_width" required="" type="number" placeholder="Enter Coloumn Width" >
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<input class="form-control" name="advertiser_name" required="" type="text" placeholder="Enter Advertiser Name">
												</div>
												
												<div class="form-group">
													<label class="" >Advertiser Address:</label><sup style="color: red;">*</sup>
													<input class="form-control" name="advertiser_address" required="" type="text" placeholder="Enter Advertiser Name">
												</div>

													<div class="form-group">
													<label class="" >Advertiser Place:</label><sup style="color: red;">*</sup>
													<input class="form-control" name="advertiser_place" required="" type="text" placeholder="Enter Advertiser Name">
												</div>
