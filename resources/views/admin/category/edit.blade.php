							...
							<div class="card custom-card">
								<div class="card-body">
									...
									<hr>
														...
														<form class="form-horizontal" role="form" method="POST" action="{{config('app.baseURL')}}/admin/update-category/{{$category->id}}" enctype="multipart/form-data" >
																															@csrf
										...
										<div class="col-md-12 col-lg-12 col-xl-12" style="margin-top: 14px;">
											<div class="">
												<div class="form-group">
													...
													<input class="form-control" name="name" required="" type="text" placeholder="Enter Category Name" value="{{$category->name}}">
												</div>
