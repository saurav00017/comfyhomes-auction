						...
						<div class="col-lg-12 col-md-12">
							<div class="card custom-card">
								<div class="card-body">
									...
									<div>
										<a href="{{config('app.baseURL')}}/admin/bank-management" style="float: inline-end;"> <button type="submit" class="btn pull-right btn btn-primary panel-button add-btn" >Back</button></a><br>
								...
								<form class="form-horizontal" role="form" method="POST" action="{{config('app.baseURL')}}/admin/update-bank/{{$bank->id}}" enctype="multipart/form-data" >
																															@csrf
										...
										<div class="col-md-12 col-lg-12 col-xl-12" style="margin-top: 14px;">
											<div class="">
												...
												<div class="form-group">
													...
													<div class="img-wrap">
                             <img class="image-size slider-img"  src="{{config('app.baseURL')}}/storage/app/{{$bank->icon}}" alt="" style="height: 100px;">&nbsp;
                          </div><br>
                          @if($bank->icon!="")
												...
												<div class="form-group">
													...
													<input class="form-control" name="bank_name" required="" type="text" placeholder="Enter Bank Name" value="{{$bank->bank_name}}">
												</div>
