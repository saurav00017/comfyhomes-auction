                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <a href="{{ config('app.baseURL') }}/admin/create-bank"> <button type="submit"
            ...
            var table = $('#data-table').DataTable({
                ...
                columns: [
...

                    {
                        ...
                        "ilter": false,
                        "mRender": function(data, type, row) {
                            return "<a class=datatable-left-link href={{ config('app.baseURL') }}/admin/update-bank/" +
                                row.id +
                                "><span><button type='submit' class='btn btn-primary mr-1'>Update</button></span></a><a class=datatable-left-link href={{ config('app.baseURL') }}/admin/delete-bank/" +
                                row.id +
    ...
    <script>
        $(document).on('change', '.status-toggle', function() {
            ...
            var endpoint = isActive ?
                "{{ config('app.baseURL') }}/admin/active-bank/" + id :
                "{{ config('app.baseURL') }}/admin/inactive-bank/" + id;
