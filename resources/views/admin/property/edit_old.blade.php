	...
	<div class="container-fluid">
					...
					<div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{config('app.baseURL')}}/admin/property-update/{{$property->id}}" enctype="multipart/form-data" >
                      ...
                      <div class="form-group">
												<label class="">Ready To Move:</label><sup style="color: red;">*</sup>
													<div class="pos-relative">
 ...
 -->
                     ...
                     <div class="form-group">
							                  ...
							                  <option value="">select No Of Floors</option>
							                      <option value="1" <?php if ($property->type == 1) echo "selected"; ?>>1 Floor</option>
                                    <option value="2" <?php if ($property->type == 2) echo "selected"; ?>>2 Floor</option>
                                    <option value="3" <?php if ($property->type == 3) echo "selected"; ?>>3 Floor</option>
                                    <option value="4" <?php if ($property->type == 4) echo "selected"; ?>>4 Floor</option>
                                    <option value="5" <?php if ($property->type == 5) echo "selected"; ?>>5 Floor</option>
                                    <option value="6" <?php if ($property->type == 6) echo "selected"; ?>>6 Floor</option>
                                    <option value="7" <?php if ($property->type == 7) echo "selected"; ?>>7 Floor</option>
                                    <option value="8" <?php if ($property->type == 8) echo "selected"; ?>>8 Floor</option>
                                    <option value="9" <?php if ($property->type == 9) echo "selected"; ?>>9 Floor</option>
                                    <option value="10" <?php if ($property->type == 10) echo "selected"; ?>>10 Floor</option>
                                    <option value="11" <?php if ($property->type == 11) echo "selected"; ?>>11 Floor</option>
                                    <option value="12" <?php if ($property->type == 12) echo "selected"; ?>>12 Floor</option>
                                    <option value="13" <?php if ($property->type == 13) echo "selected"; ?>>13 Floor</option>
                                    <option value="14" <?php if ($property->type == 14) echo "selected"; ?>>14 Floor</option>
                                    <option value="15" <?php if ($property->type == 15) echo "selected"; ?>>15 Floor</option>		
                                    <option value="16" <?php if ($property->type == 16) echo "selected"; ?>>16 Floor</option>	
                                    <option value="17" <?php if ($property->type == 17) echo "selected"; ?>>17 Floor</option>
                                    <option value="18" <?php if ($property->type == 18) echo "selected"; ?>>18 Floor</option>
                                    <option value="19" <?php if ($property->type == 19) echo "selected"; ?>>19 Floor</option>	
                                    <option value="20" <?php if ($property->type == 20) echo "selected"; ?>>20 Floor</option>							        
                          </select>
												</div>
											</div>
											...
											<div class="form-group">
												<label class="">No of Towers:</label><sup style="color: red;">*</sup>
												  <div class="pos-relative">
														<input class="form-control pd-r-80" name="no_of_towers" type="number" placeholder="Enter No of Towers" value="{{$property->no_of_towers}}">
												 </div>
											</div>
											...
											<div class="form-group">
												<label class="">No of Lifts:</label><sup style="color: red;">*</sup>
												  <div class="pos-relative">
														<input class="form-control pd-r-80" name="no_of_lifts" type="number" placeholder="Enter No of Lifts" value="{{$property->no_of_lifts}}">
												 </div>
											</div>
											...
											<div class="form-group">
												<label class="">No of Flats:</label><sup style="color: red;">*</sup>
												  <div class="pos-relative">
														<input class="form-control pd-r-80" name="no_of_flats" type="number" placeholder="Enter No of Flats" value="{{$property->no_of_flats}}">
												 </div>
											</div>
											...
											<div class="form-group">
												<label class="">No of Balcony:</label><sup style="color: red;">*</sup>
												  <div class="pos-relative">
														<input class="form-control pd-r-80" name="no_of_blacony" type="number" placeholder="Enter No of Balcony" value="{{$property->no_of_blacony}}">
												 </div>
											</div>
											...
											<div class="form-group">
												<label class="">Map:</label><sup style="color: red;">*</sup>
												  <div class="pos-relative">
														<input class="form-control pd-r-80" name="iframe" type="text" placeholder="Enter Map link" value="{{$property->iframe}}">
												 </div>
											</div>
