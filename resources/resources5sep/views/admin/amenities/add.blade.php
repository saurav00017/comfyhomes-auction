...
<body>
	<div class="container-fluid">
					...
					<div class="page-header">
						<div>
							<h2 class="main-content-title tx-24 mg-b-5"> Create Amenity</h2>
							<ol class="breadcrumb">
							...
							<div class="card custom-card">
								<div class="card-body">
									...
									<a href="{{config('app.baseURL')}}/admin/ameneties-management" style="float: inline-end;" > <button type="submit" class="btn pull-right btn btn-primary panel-button add-btn">Back</button></a><br>
										<h6 class="card-title mb-1">Create Amenity Form</h6>
										<!-- <p class="text-muted card-sub-title">A form group layout for entering card information upon checkout.</p> -->
									</div>
									<hr>
									<form class="form-horizontal" role="form" method="POST" action="ameneties-create" enctype="multipart/form-data" >
									@csrf
									<div class="row">
										<div class="col-md-12 col-lg-12 col-xl-12" style="margin-top: 14px;">
											<div class="">
												<div class="form-group">
													...
													<input class="form-control" name="name" required="" type="text" placeholder="Enter Amenities Name">
												</div>
