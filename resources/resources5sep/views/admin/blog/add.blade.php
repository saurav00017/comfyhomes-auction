...
<body>
	<div class="container-fluid">
					...
					<div class="page-header">
						<div>
							<h2 class="main-content-title tx-24 mg-b-5"> Create Blog</h2>
							<ol class="breadcrumb">
						...
						<div class="col-lg-12 col-md-12">
							<div class="card custom-card">
								<div class="card-body">
									...
									<hr>
									<form class="form-horizontal" role="form" method="POST" action="blog-create" enctype="multipart/form-data" >
																@csrf
