                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="about-contact-grid style2">
                        ...
                        <div class="about-contact-details">
                            ...
                            <p class="about-contact-details-text"><a href="mailto:proberries@gmail.com">proberries@gmail.com</a></p>
                            <p class="about-contact-details-text"><a href="mailto:vinod@gmail.com">vinod@gmail.com</a></p>
            ...
            <div class="row gx-35">
                <div class="col-lg-6">
                    <div class="appointment-wrap2 bg-white me-xxl-5">
                        ...
                        <form action="{{config('app.baseURL')}}/contact" method="POST" class="appointment-form">
                            @csrf
                            <div class="row">
