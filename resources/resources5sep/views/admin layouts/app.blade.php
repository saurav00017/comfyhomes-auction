...
*/
   ...
   .btn-primary{
   	background-color: #8a7b8e important;
   	} 
    ...
    background-color: #8a7b8eimportant;
...
<script src="{{config('app.baseURL')}}/admin-assets/js/notify.min.js" type="text/javascript"></script>  
		...
		<!-- Jquery-Ui js-->
<script src="{{config('app.baseURL')}}/admin-assetsadmin-assets/plugins/jquery-ui/ui/widgets/datepicker.js"></script>
<!-- Select2 js-->
<script src="{{config('app.baseURL')}}/admin-assets/plugins/select2/js/select2.min.js"></script>
<!-- Daternagepicker js-->
<script src="{{config('app.baseURL')}}/admin-assets/plugins/bootstrap-daterangepicker/moment.min.js"></script>
<script src="{{config('app.baseURL')}}/admin-assets/plugins/bootstrap-daterangepicker/daterangepicker.js"></script>
<!--Fileuploads js-->
<script src="{{config('app.baseURL')}}/admin-assets/plugins/fileuploads/js/fileupload.js"></script>
<script src="{{config('app.baseURL')}}/admin-assets/plugins/fileuploads/js/file-upload.js"></script>
<!--Fancy uploader js-->
<script src="{{config('app.baseURL')}}/admin-assets/plugins/fancyuploder/jquery.ui.widget.js"></script>
<script src="{{config('app.baseURL')}}/admin-assets/plugins/fancyuploder/jquery.fileupload.js"></script>
<script src="{{config('app.baseURL')}}/admin-assets/plugins/fancyuploder/jquery.iframe-transport.js"></script>
<script src="{{config('app.baseURL')}}/admin-assets/plugins/fancyuploder/jquery.fancy-fileupload.js"></script>
<script src="{{config('app.baseURL')}}/admin-assets/plugins/fancyuploder/fancy-uploader.js"></script>
<!-- Form-elements js-->
...
<script src="{{config('app.baseURL')}}/admin-assets/js/scripts/datatables/dataTables.buttons.min.js"></script>
<script src="{{config('app.baseURL')}}/admin-assets/js/scripts/datatables/jszip.min.js"></script>
<script src="{{config('app.baseURL')}}/admin-assets/js/scripts/datatables/pdfmake.min.js"></script>
<script src="{{config('app.baseURL')}}/admin-assets/js/scripts/datatables/vfs_fonts.js"></script>
<script src="{{config('app.baseURL')}}/admin-assets/js/scripts/datatables/buttons.html5.min.js"></script>
<script src="{{config('app.baseURL')}}/admin-assets/js/scripts/datatables/buttons.print.min.js"></script>
