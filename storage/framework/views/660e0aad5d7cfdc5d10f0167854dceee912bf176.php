  ...
  <div class="row ">
    <div class="col-12" >
      <div class="card">
        ...
        <a href="<?php echo e(config('app.baseURL')); ?>/admin/property-create"> <button type="submit" class="btn pull-right btn btn-primary panel-button add-btn">Create Property</button></a><br>
...
$(document).ready( function () {
    ...
    var table = $('#data-table').DataTable({
        ...
        serverSide: true,
        order: [[0, 'desc']],
        ajax: "<?php echo e(config('app.baseURL')); ?>/admin/property-management-allData",
        columns: [
        ...
        // },
         ...
         {"targets":-1,
             ...
             if(row.is_active==0){
              ...
              return "<a class=datatable-left-link href=<?php echo e(config('app.baseURL')); ?>/admin/active-property/" + row.id+"><span><button type='submit' class='btn btn-success'>Activate</button></span></a>";
              ...
              return "<a class=datatable-left-link href=<?php echo e(config('app.baseURL')); ?>/admin/inactive-property/" + row.id+"><span><button type='submit' class='btn btn-danger'>InActivate</button></span></a>";
               }
            },
          },
             ...
             "ilter":false,
             "mRender": function(data, type, row){
              return "<a class=datatable-left-link href=<?php echo e(config('app.baseURL')); ?>/admin/property-update/" + row.id+"><span><button type='submit' class='btn btn-success mr-1'>Update</button></span></a>  <a class=datatable-left-link href=<?php echo e(config('app.baseURL')); ?>/admin/property-delete/" + row.id+"><span><button type='submit' class='btn btn-danger mr-1'>Delete</button></span></a>";
        ...
        //       {
        //          return "<a class=datatable-left-link href=<?php echo e(config('app.baseURL')); ?>/admin/sharing/all/" + row.proprty_id+"><span><button type='submit' class='btn btn-primary mr-1'>Create Sharing</button></span></a>";
...
<?php echo $__env->make('admin layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/propberries/public_html/resources/views/admin/property/all.blade.php ENDPATH**/ ?>