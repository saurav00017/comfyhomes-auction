							...
							<div class="card custom-card">
								<div class="card-body">
									...
									<div>
										...
										<h6 class="card-title mb-1">Create Subscription Form</h6>
										<!-- <p class="text-muted card-sub-title">A form group layout for entering card information upon checkout.</p> -->

									</div>
									<hr>

														<form class="form-horizontal" role="form" method="POST" action="create-subscription" enctype="multipart/form-data" >
																															<?php echo csrf_field(); ?>
										...
										<div class="col-md-12 col-lg-12 col-xl-12" style="margin-top: 14px;">
											<div class="">
												<div class="form-group">
													...
													<input class="form-control" name="days" required="" type="number" placeholder="Enter No of Days">
												</div>

												<div class="form-group">
													<label class="" >Price:</label><sup style="color: red;">*</sup>
													<input class="form-control" name="price" required="" type="text" placeholder="Enter Price">
												</div>

												<div class="form-group">
													<label class="" >Discont Price:</label><sup style="color: red;">*</sup>
													<input class="form-control" name="offer_price" required="" type="text" placeholder="Enter Discount Price">
												</div>

												<div class="form-group">
													<label class="" >Discont Percentage:</label><sup style="color: red;">*</sup>
													<input class="form-control" name="offer_percentage" required="" type="text" placeholder="Enter Discont Percentage">
												</div>

												<!-- <div class="form-group">
													<label class="" >Refund Instruction:</label><sup style="color: red;">*</sup>
													<input class="form-control" name="refund_instruction" required="" type="text" placeholder="Enter Refund Instruction">
												</div> -->
								           ...
								           <p class="mg-b-10">Category Listing:<sup style="color: red;">*</sup></p>
								            <select class="form-control" name="category_listing" required="">
								              <option value="">Select Category Listing:</option>                         
								                 <option value="1">One Listing</option>
...
<?php echo $__env->make('admin layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\auction-comfyhomes\resources\views/admin/subscription/add.blade.php ENDPATH**/ ?>