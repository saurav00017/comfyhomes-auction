...
<script src="<?php echo e(config('app.baseURL')); ?>/assets/js/bootstrap.min.js"></script>
 -->
    <!---Select2 css-->
<!-- <link href="<?php echo e(config('app.baseURL')); ?>/assets/plugins/select2/css/select2.min.css" rel="stylesheet"> -->
<!-- Jquery js-->
<!-- <script src="<?php echo e(config('app.baseURL')); ?>/assets/plugins/jquery/jquery.min.js"></script> -->
...
<script src="<?php echo e(config('app.baseURL')); ?>/admin-assets/js/jquery-1.12.4.min.js"></script>
<script src="<?php echo e(config('app.baseURL')); ?>/admin-assets/js/bootstrap.min.js"></script>
					...
					<div class="row">
						<div class="col-lg-12 col-md-12">
							<div class="card custom-card">
								<div class="card-body">
									<div>
									<a href="<?php echo e(config('app.baseURL')); ?>/admin/property-management" style="float: inline-end;" > <button type="submit" class="btn pull-right btn btn-primary panel-button add-btn">Back</button></a><br>
                     ...
                     <div class="form-group">
												<label class="">Possession:</label><sup style="color: red;">*</sup>
													<div class="pos-relative">
														<input class="form-control pd-r-80" name="possession" required="" type="text" placeholder="Enter possession">
													</div>
											</div>
                      ...
                      <div class="form-group">
											...
											<div class="form-group">
												<label class="">Flat Type:</label><sup style="color: red;">*</sup>
													<div class="pos-relative">
														<input class="form-control pd-r-80" name="flat_type" required="" type="text" placeholder="Enter Flat Type">
													</div>
											</div>
    ...
    <option value="40">40 Floor</option>
											...
											<div class="form-group">
												<label class="">No of Towers:</label><sup style="color: red;">*</sup>
												  <div class="pos-relative">
														<input class="form-control pd-r-80" name="no_of_towers" required="" type="number" placeholder="Enter No of Towers">
												 </div>
											</div>
											...
											<div class="form-group">
												<label class="">No of Lifts:</label><sup style="color: red;">*</sup>
												  <div class="pos-relative">
														<input class="form-control pd-r-80" name="no_of_lifts" required="" type="number" placeholder="Enter No of Lifts">
												 </div>
											</div>
											...
											<div class="form-group">
												<label class="">No of Flats:</label><sup style="color: red;">*</sup>
												  <div class="pos-relative">
														<input class="form-control pd-r-80" name="no_of_flats" required="" type="number" placeholder="Enter No of Flats">
												 </div>
											</div>
											...
											<div class="form-group">
												<label class="">No of Balcony:</label><sup style="color: red;">*</sup>
												  <div class="pos-relative">
														<input class="form-control pd-r-80" name="no_of_blacony" required="" type="number" placeholder="Enter No of Balcony">
												 </div>
											</div>
											...
											<div class="form-group">
												<label class="">Map:</label><sup style="color: red;">*</sup>
												  <div class="pos-relative">
														<input class="form-control pd-r-80" required="" name="iframe" type="text" placeholder="Enter Map link">
												 </div>
											</div>
											...
											<div class="form-group hidden" id="sprice">
								               <label class="">Property Selling Price:</label><sup style="color: red;">*</sup>
								                <div class="pos-relative">
									            <input class="form-control pd-r-80" name="selling_price" required=""  type="text" placeholder="Enter Property Selling Price">
								            </div>
							                </div>
							       ...
							       <!--   <div class="form-group">
												...
												<div class="form-group">
													...
													<input class="form-control" required="" name="thumbnil_image" type="file">
												</div>
                            ...
                            <p class="mg-b-10">Property Amenety:<sup style="color: red;">*</sup></p>
                              <select class="form-control select2" name="amenety_id[]" multiple="multiple" required=""> 
                                <option value="">Select Property Amenety</option>                        
								                 <?php $__currentLoopData = $amenety; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $amenetys): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								                      <option value="<?php echo e($amenetys->id); ?>"><?php echo e($amenetys->name); ?></option>
						                       ...
						                       <div class="form-group">
												<label class="">Description:</label><sup style="color: red;">*</sup>
												  <div class="pos-relative">
														<input class="form-control pd-r-80" name="description" required="" type="text" placeholder="Enter Description">
												 </div>
											</div>
...
<!--Sumoselect js-->
<script src="<?php echo e(config('app.baseURL')); ?>/admin-assets/plugins/sumoselect/jquery.sumoselect.js"></script>
...
<?php echo $__env->make('admin layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/propberries/public_html/resources/views/admin/property/add.blade.php ENDPATH**/ ?>