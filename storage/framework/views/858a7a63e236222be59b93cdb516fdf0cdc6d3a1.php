			<div class="main-sidebar main-sidebar-sticky side-menu" style="">
				<div class="sidemenu-logo">
			<a class="main-logo" href="">

					
						<img src="<?php echo e(config('app.baseURL')); ?>/assets/img/propberries.jpeg" class="header-brand-img desktop-logo" alt="logo" class="img-responsive"  style="height: 118px!important;">
				
						<img src="<?php echo e(config('app.baseURL')); ?>/assets/img/propberries.jpeg" class="header-brand-img icon-logo" alt="logo">
				...
				<div class="main-sidebar-body" >
					<ul class="nav">
						...
						<li class="nav-item" id="l15">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/dashboard"><i class="fe fe-airplay"></i><span class="sidemenu-label">Dashboard</span></a>
						</li> -->
						<li class="nav-label">Applications</li>
						<!-- <li class="nav-item" id="l1">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/user/all" ><i class="fe fe-user"></i><span class="sidemenu-label">Admin User</span></a>
						</li>
						
						<li class="nav-item" id="l8">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/usermanagement/all" ><i class="fe fe-user"></i><span class="sidemenu-label">App Customer</span></a>
						</li>
						<li class="nav-item" id="l12">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/category/all" ><i class="fe fe-box"></i><span class="sidemenu-label">Category</span></a>
						</li>
						<li class="nav-item" id="l2">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/role/all"><i class="fe fe-box"></i><span class="sidemenu-label">Role</span></a>
						</li>
						<li class="nav-item" id="l7">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/banner/all"><i class="fe fe-box"></i><span class="sidemenu-label">Banner</span></a>
						</li>-->
						<li class="nav-item" id="l4">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/user-management"><i class="fe fe-box"></i><span class="sidemenu-label">User</span></a>
						</li>
						 <li class="nav-item" id="l24">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/category-management"><i class="fe fe-box"></i><span class="sidemenu-label">Category</span></a>
						</li> 
						 <li class="nav-item" id="l24">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/sub-category-management"><i class="fe fe-box"></i><span class="sidemenu-label">Sub Category</span></a>
						</li> 
						<li class="nav-item" id="l9">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/subscription-management"><i class="fe fe-box"></i><span class="sidemenu-label">Subscription</span></a>
						</li>
						<li class="nav-item" id="l3">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/notice-management"><i class="fe fe-box"></i><span class="sidemenu-label">Notice</span></a>
						</li>
						<li class="nav-item" id="l3">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/advertising-management"><i class="fe fe-box"></i><span class="sidemenu-label">Advertising</span></a>
						</li>
						
						<li class="nav-item" id="l6">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/auction-management

							"><i class="fe fe-box"></i><span class="sidemenu-label">Auction</span></a>
						</li> 

						<li class="nav-item" id="l6">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/bank-management

							"><i class="fe fe-box"></i><span class="sidemenu-label">Bank</span></a>
						</li> 
						<!-- <li class="nav-item" id="l5">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/property-management"><i class="fe fe-box"></i><span class="sidemenu-label">Property</span></a>
						</li>
						
						
						 
						<li class="nav-item" id="l11">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/visitor-management"><i class="fe fe-box"></i><span class="sidemenu-label">Visitor Schedule</span></a>
						</li>	 -->
						
						<!--<li class="nav-item" id="l19">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/tenant/all"><i class="fe fe-user"></i><span class="sidemenu-label">Tenant</span></a>
						</li>	

                        <li class="nav-item" id="l21">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/schedule/all"><i class="fe fe-clock"></i><span class="sidemenu-label">Schedule</span></a>
						</li>	
						 <li class="nav-item" id="l22">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/bed/allReservedBed"><i class="fe fe-box"></i><span class="sidemenu-label">Reserved</span></a>
						</li>	
						<li class="nav-item" id="l20">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/tenant/rent-pending"><i class="fe fe-user"></i><span class="sidemenu-label">Defaulter Tenant</span></a>
						</li>			
						<li class="nav-item" id="l14">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/notification/all"><i class="fe fe-bell"></i><span class="sidemenu-label">Notification</span></a>
						</li>	

                        <li class="nav-item" id="l25">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/service/all"><i class="fe fe-box"></i><span class="sidemenu-label">Support</span></a>
						</li>	 -->
						<!-- <li class="nav-item" id="l16">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/agreement/all"><i class="fe fe-file"></i><span class="sidemenu-label">Agreement</span></a>
						</li> -->
						<!-- <li class="nav-item" id="l17">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/leadgenerate/all"><i class="fe fe-user"></i><span class="sidemenu-label">Add Lead</span></a>
						</li>
						<li class="nav-item" id="l18">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/calender/all"><i class="fe fe-calendar"></i><span class="sidemenu-label">Calendar</span></a>
						</li>

						<li class="nav-item" id="l23">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/benefits/all"><i class="fe fe-file"></i><span class="sidemenu-label">Benefits</span></a>
						</li>		
 -->
								<!-- <li class="nav-item">
							<a class="nav-link with-sub" href="<?php echo e(config('app.baseURL')); ?>/admin/user/all"><i class="fe fe-mail"></i><span class="sidemenu-label"></span><span class="badge badge-primary side-badge">2</span></a>
							<a class="nav-link with-sub" href="<?php echo e(config('app.baseURL')); ?>/admin/propertype/all"><i class="fe fe-mail"></i><span class="sidemenu-label">Proprty Type</span><span class="badge badge-primary side-badge">2</span></a>
							<a class="nav-link with-sub" href="<?php echo e(config('app.baseURL')); ?>/admin/amenety/all"><i class="fe fe-mail"></i><span class="sidemenu-label">Amenety</span><span class="badge badge-primary side-badge">2</span></a>
							<a class="nav-link with-sub" href="<?php echo e(config('app.baseURL')); ?>/admin/property/all"><i class="fe fe-mail"></i><span class="sidemenu-label">Property</span><span class="badge badge-primary side-badge">2</span></a>
							<a class="nav-link with-sub" href="<?php echo e(config('app.baseURL')); ?>/admin/propertyFeatures/all"><i class="fe fe-mail"></i><span class="sidemenu-label">Property Features</span><span class="badge badge-primary side-badge">2</span></a> -->
							<!-- <ul class="nav-sub">
			...
			<!-- End Sidemenu--><?php /**PATH C:\xampp\htdocs\auction\resources\views/admin layouts/sidemenu.blade.php ENDPATH**/ ?>