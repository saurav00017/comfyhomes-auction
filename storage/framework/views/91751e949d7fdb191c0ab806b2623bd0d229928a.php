...
<?php $__env->startSection('content'); ?>
    ...
    <div id="printArea">
        ...
        <div class="content">
            ...
            <div class="collumn" style="width: <?php echo e($notices->column_width); ?>%;">
                <div class="head">
                    <span class="headline hl3">
                        <img class="image-size slider-img" src="<?php echo e(config('app.baseURL')); ?>/storage/app/<?php echo e($notices->image); ?>" alt="">
                    </span>
                    <p style="background-color:black;"><span class="headline hl4" style="color: white;">Public Notice</span></p>
                </div>
                <p><?php echo e($notices->description); ?></p>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/comfyhomes/public_html/auction/resources/views/notice.blade.php ENDPATH**/ ?>