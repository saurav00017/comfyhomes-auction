                ...
                <div class="col-md-4">
                    <div class="row">
                        ...
                        <?php if(!$upcomingauction->isEmpty()): ?>
                            <div>
                                <a href="<?php echo e(config('    ')); ?>/search">
                    ...
                    <?php if($upcomingauction->isEmpty()): ?>
                        ...
                        <div class="text-center">
                            <img src="<?php echo e(asset('assets/img/coming-soon.png')); ?>" alt="No Auctions Available"
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $upcomingauction; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upcomingauctions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td >
                                                <?php echo e($loop->iteration + ($upcomingauction->currentPage() - 1) * $upcomingauction->perPage()); ?>

                                            </td>
                                            <td >
                                                <?php echo e($upcomingauctions->id); ?></td>
                                            <td >
                                                <?php echo e($upcomingauctions->bank->bank_name); ?></td>
                                            <td >
                                                <?php echo e($upcomingauctions->locality); ?></td>
                                            <td >
                                                <?php echo e($upcomingauctions->auction_start_datetime); ?></td>
                                            <td >
                                                <?php echo e($upcomingauctions->auction_end_datetime); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
                            ...
                            <div class="pagination-container">
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-center">
                                        ...
                                        <?php else: ?>
                                            <li class="page-item">
                                                <a class="page-link" href="<?php echo e($upcomingauction->previousPageUrl()); ?>"
                                                    rel="prev">Previous</a>
                                            </li>
                                        <?php endif; ?>
                                        ...
                                        <?php if($upcomingauction->hasMorePages()): ?>
                                            <li class="page-item">
                                                <a class="page-link" href="<?php echo e($upcomingauction->nextPageUrl()); ?>"
                                                    rel="next">Next</a>
                                            </li>
                                        <?php else: ?>
                                            <li class="page-item disabled">
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
                            ...
                            <?php if(!$auction->isEmpty()): ?>
                                <a href="<?php echo e(config('app.baseURL')); ?>/verify-auction" class="btn btn-outline-primary">
                        ...
                        <div class="card-body">
                            <?php if($auction->isEmpty()): ?>
                                <div class="text-center py-5">
                                    <img src="<?php echo e(asset('assets/img/coming-soon.png')); ?>" alt="No Auctions Available" class="img-fluid" style="max-height: 200px;">
                            ...
                            <?php else: ?>
                                            ...
                                            <?php $__currentLoopData = $auction; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $auctions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr class="align-middle">
                                                    <td class="text-center">
                                                        <?php echo e($loop->iteration + ($auction->currentPage() - 1) * $auction->perPage()); ?>

                                                    </td>
                                                    <td class="text-center"><?php echo e($auctions->id); ?></td>
                                                    <td class="text-center"><?php echo e($auctions->bank->bank_name); ?></td>
                                                    <td class="text-center">
                                                        <span class="badge bg-light text-dark"><?php echo e($auctions->locality); ?></span>
                                                    </td>
                                                    <td class="text-center text-nowrap">
                                                        <span class="badge bg-info text-white">
                                                            <?php echo e(\Carbon\Carbon::parse($auctions->auction_start_datetime)->format('d M Y')); ?>

                                                        </span>
                                                    </td>
                                                    <td class="text-center text-nowrap">
                                                        <span class="badge bg-danger text-white">
                                                            <?php echo e(\Carbon\Carbon::parse($auctions->auction_end_datetime)->format('d M Y')); ?>
                                ...
                                <!-- Pagination -->
                                <?php if($auction->hasPages()): ?>
                                    <div class="d-flex justify-content-between align-items-center mt-4">
                                        <div class="text-muted">
                                            Showing <?php echo e($auction->firstItem()); ?> to <?php echo e($auction->lastItem()); ?> of <?php echo e($auction->total()); ?> entries
                                        </div>
                                        <nav aria-label="Page navigation">
                                            <ul class="pagination mb-0">
                                                ...
                                                <?php else: ?>
                                                    <li class="page-item">
                                                        <a class="page-link" href="<?php echo e($auction->previousPageUrl()); ?>" rel="prev">
                                                ...
                                                <?php if($auction->hasMorePages()): ?>
                                                    <li class="page-item">
                                                        <a class="page-link" href="<?php echo e($auction->nextPageUrl()); ?>" rel="next">
                    ...
                    <div class="swiper th-slider property-thumb-slider">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <img src="<?php echo e(asset('assets/img/bank/sbi.png')); ?>" alt="Dummy Image">
                            </div>
                            <!-- Swiper Slide 2 -->
                            <div class="swiper-slide">
                                <img src="<?php echo e(asset('assets/img/bank/kotak.png')); ?>" alt="Dummy Image">
                            </div>
                            <!-- Swiper Slide 3 -->
                            <div class="swiper-slide">
                                <img src="<?php echo e(asset('assets/img/bank/icici.png')); ?>" alt="Dummy Image">
                            </div>
                            <!-- Swiper Slide 4 -->
                            <div class="swiper-slide">
                                <img src="<?php echo e(asset('assets/img/bank/hdfc.png')); ?>" alt="Dummy Image">
                            </div>

                            <div class="swiper-slide">
                                <img src="<?php echo e(asset('assets/img/bank/maharashtra.png')); ?>" alt="Dummy Image">
                            </div>
                            <div class="swiper-slide">
                                <img src="<?php echo e(asset('assets/img/bank/saraswatbank.png')); ?>" alt="Dummy Image">
                            </div>
                            <div class="swiper-slide">
                                <img src="<?php echo e(asset('assets/img/bank/central.png')); ?>" alt="Dummy Image">
                            </div>
                            <div class="swiper-slide">
                                <img src="<?php echo e(asset('assets/img/bank/pnb.png')); ?>" alt="Dummy Image">
                            </div>
    ...
    <div class="pricing">
        ...
        <?php $__currentLoopData = $premium; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $premiumItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="plan popular">
                ...
                <h2>Pro</h2>
                <div class="price">
                    ₹<?php echo e($premiumItem->price - $premiumItem->offer_price); ?>

                    <small>₹<?php echo e($premiumItem->price); ?></small>
                </div>

                <div class="discount-container">
                    <strong class="discount-badge"><?php echo e($premiumItem->offer_percentage); ?>% Off</strong>
                </div>

                <div class="duration">
                    <strong>Duration:</strong> <?php echo e($premiumItem->days); ?> Days
                </div>
                <ul class="features">
                    ...
                    <li><i class="fas fa-check-circle"></i> <?php echo e($premiumItem->email_support == '1' ? 'check' : 'times'); ?>

                        Certification</li>
                    <li><i class="fas fa-<?php echo e($premiumItem->email_support == '1' ? 'check' : 'times'); ?>-circle"></i> Email
                        Support</li>
                    <li><i class="fas fa-check-circle"></i> Payment Guarantee</li>
                </ul>
                <?php if(auth()->guard()->guest()): ?>
                    <button onclick="window.location.href='<?php echo e(config('app.baseURL')); ?>/register'">Register Now</button>
                <?php else: ?>
                    <button onclick="showConfirmationModal(<?php echo e($premiumItem->id); ?>)">Buy
                        Now</button>
                <?php endif; ?>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\auction-comfyhomes\resources\views/index.blade.php ENDPATH**/ ?>