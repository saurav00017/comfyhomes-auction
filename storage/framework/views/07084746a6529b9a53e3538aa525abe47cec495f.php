            ...
            <div class="collumn" style="width: 30%;">
                <div class="head">
                    <span class="headline hl3">
                        <img class="image-size slider-img" src="<?php echo e(config('app.baseURL')); ?>/storage/app/<?php echo e($propertys->property_image); ?>" alt="">
                    </span>
                    <p style="background-color:black;"><span class="headline hl4" style="color: white;">Auction</span></p>
                </div>
        <p><?php echo $propertys->description; ?></p>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\auction\resources\views/eauction.blade.php ENDPATH**/ ?>