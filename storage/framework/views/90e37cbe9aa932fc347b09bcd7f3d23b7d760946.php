  ...
  <div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
      <div class="row breadcrumbs-top">
        <div class="col-12">
           <h4 class="card-title" style="color:  #880808;">All Category</h4>
  ...
  <div class="row">
    <div class="col-12" >
      <div class="card">
        ...
        <a href="<?php echo e(config('app.baseURL')); ?>/admin/create-category"> <button type="submit" class="btn pull-right btn btn-primary panel-button add-btn" >Create Category</button></a><br>
...
$(document).ready( function () {
    var table = $('#data-table').DataTable({
        ...
        serverSide: true,
        order: [[0, 'desc']],
        ajax: "<?php echo e(config('app.baseURL')); ?>/admin/category-management-allData",
        columns: [
        
 {
        ...
        {"targets":-1,
             ...
             "mRender": function(data, type, row) {
             if(row.is_active==0){
             return "<a class=datatable-left-link href=<?php echo e(config('app.baseURL')); ?>/admin/active-category/" + row.id+"><span><button type='submit' class='btn btn-success'>Active</button></span></a>";
              
            }
            else{
               return "<a class=datatable-left-link href=<?php echo e(config('app.baseURL')); ?>/admin/inactive-category/" + row.id+"><span><button type='submit' class='btn btn-danger'>InActive</button></span></a>";
               }
            },
          },
...
<?php echo $__env->make('admin layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\auction\resources\views/admin/category/all.blade.php ENDPATH**/ ?>