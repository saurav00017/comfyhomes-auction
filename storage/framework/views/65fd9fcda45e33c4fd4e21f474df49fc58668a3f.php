			<div class="main-sidebar main-sidebar-sticky side-menu" style="background-color: #8a7b8e!important;">
				<div class="sidemenu-logo">
			<a class="main-logo" href="">

					
						<img src="<?php echo e(config('app.baseURL')); ?>/assets/img/propberries.jpeg" class="header-brand-img desktop-logo" alt="logo" class="img-responsive"  style="height: 90px!important;border-radius: 21px;margin-top: 5px;">
				...
				<div class="main-sidebar-body" >
					<ul class="nav">
						...
						<li class="nav-item" id="l4">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/ameneties-management"><i class="fe fe-box"></i><span class="sidemenu-label">Amenity</span></a>
						</li>
						 <li class="nav-item" id="l24">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/blog-management"><i class="fe fe-box"></i><span class="sidemenu-label">Blog</span></a>
						</li>	
						<!--<li class="nav-item" id="l9">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/offer/all"><i class="fe fe-box"></i><span class="sidemenu-label">Offer</span></a>
						</li>
						<li class="nav-item" id="l3">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/propertype/all"><i class="fe fe-box"></i><span class="sidemenu-label">Property Type</span></a>
						</li>
						
						<li class="nav-item" id="l6">
							<a class="nav-link" href="<?php echo e(config('app.baseURL')); ?>/admin/propertyFeatures/all"><i class="fe fe-box"></i><span class="sidemenu-label">Property Features</span></a>
						</li> -->
 ...
 -->
			...
			<!-- End Sidemenu--><?php /**PATH /home/propberries/public_html/resources/views/admin layouts/sidemenu.blade.php ENDPATH**/ ?>