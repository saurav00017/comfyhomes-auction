            ...
            <div class="counter-card-wrap space">
                <div class="counter-card style2">
                    <div class="media-body">
                        <h2 class="box-number"><span class="counter-number">15</span>+</h2>
                        <p class="box-text">YEARS OF EXPERIENCES</p>
                    </div>
                </div>
                <div class="counter-card style2">
                    <div class="media-body">
                        <h2 class="box-number"><span class="counter-number">68</span>+</h2>
    ...
    <div class="client-area-1 space bg-title-dark overflow-hidden">
        <div class="container">
            <div class="slider-area client-slider1">
                <div class="swiper th-slider has-shadow" id="clientSlider1" data-slider-options='{"breakpoints":{"0":{"slidesPerView":2},"576":{"slidesPerView":"3"},"768":{"slidesPerView":"4"},"992":{"slidesPerView":"5"}}}'>
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <a href="#" class="client-card">
                                <img src="assets/img/brand/brand11.png" alt="Image" style="height: 170px;">
                            </a>
                        </div>
                        
                        <div class="swiper-slide">
                            <a href="#" class="client-card">
                                <img src="assets/img/brand/brand22.jpg" alt="Image" style="height: 170px;">
                            </a>
                        </div>

                        <div class="swiper-slide">
                            <a href="#" class="client-card">
                                <img src="assets/img/brand/brand33.png" alt="Image" style="height: 170px;">
                            </a>
                        </div>

                        <div class="swiper-slide">
                            <a href="#" class="client-card">
                                <img src="assets/img/brand/brand44.png" alt="Image" style="height: 170px;">
                            </a>
                        </div>

                        <div class="swiper-slide">
                            <a href="#" class="client-card">
                                <img src="assets/img/brand/brand55.jpg" alt="Image" style="height: 170px;">
                            </a>
                        </div>
            ...
            <div class="row gx-60 align-items-center">
                ...
                <div class="col-lg-7">
                    <div class="title-area mb-35">
                        <h2 class="sec-title text-white">Reach Out Now!</h2>
                    </div>
                    <!-- <form action="#" method="POST" class="appointment-form">
                        <div class="row">
                            ...
                            <div class="col-12 for m-group style-border3">-->
                    ...
                    <form action="<?php echo e(config('app.baseURL')); ?>/contact" method="POST" class="appointment-form">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group style-border3 col-md-6">
                                    <select name="subject" id="subject" name="service_type" class="form-select">
                                        <option value="" disabled="" selected="" hidden="">Select Service Type</option>
                                        <option value="Real Estate">Real Estate</option>
                                        <option value="Apartment">Apartment</option>
                                        <option value="Residencial">Residencial</option>
                                ...
                                <div class="col-12 form-group  style-border3 style-radius">
                                    <i class="far fa-comments"></i>
                    ...
                    <div class="img-box2">
                        ...
                        <!-- <div class="about-tag">
                            <div class="about-experience-tag">
                                <span class="circle-title-anime">Propberries Living Solutions</span>
                            </div>
                            <a href="../../watch.html?v=_sI_Ps7JSEk" class="play-btn popup-video"><i class="fa-sharp fa-solid fa-play"></i></a>
                        </div> -->
                    </div>
                </div>
                <div class="col-xl-5">
                    <div class="title-area mb-32">
                        ...
                        <p class="sec-text">PropBerries provides comprehensive real estate solutions with a focus on exceptional property management and innovative services. Our expert team ensures seamless transactions and optimal property performance, tailored to meet your unique needs.</p>
                    </div>
                    <div class="about-wrap2">
                        ...
                        <div class="call-btn">
                            ...
                            <div class="btn-content">
                                ...
                                <span class="btn-text" style="font-size: medium !important;"><a href="tel:+91-9975706345">+91-997-570-6345 </a></span><br>
                                <span class="btn-text" style="font-size: medium !important;"><a href="tel:+91-9560365659">+91-956-036-5659</a></span>
                    ...
                    <div class="btn-wrap mt-5">
                        <a href="<?php echo e(config('app.baseURL')); ?>/about-us" class="th-btn style2 th-btn-icon">More About Propberries</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-6">
                    <div class="title-area">
                        ...
                        <p class="sec-text">PropBerries provides trusted real estate services with verified listings, expert guidance, and advanced tools for seamless property transactions.</p>
                    </div>
                </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="service-card style2">
                            ...
                            <h3 class="box-title"><a href="<?php echo e(config('app.baseURL')); ?>/property">Property Management</a></h3>
                            <p class="box-text">PropBerries provides comprehensive property management services, ensuring hassle-free maintenance, tenant management, and seamless property care. Trust us to handle your property with the utmost professionalism.</p>
                    ...
                    <div class="swiper-slide">
                        <div class="service-card style2">
                            ...
                            <h3 class="box-title"><a href="<?php echo e(config('app.baseURL')); ?>/property">Hand holding from site visit till possession</a></h3>
                            <p class="box-text">Enjoy seamless support with our hand-holding service from site visit to possession. We manage every step, ensuring a smooth transition and peace of mind throughout the process.</p>
                            <!--<div class="service-img img-shine">-->
                            <!--    <img src="assets/img/service/1-3.png" alt="img">-->
                            <!--</div>-->
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="service-card style2">
                            ...
                            <h3 class="box-title"><a href="<?php echo e(config('app.baseURL')); ?>/property">Home Loan Support</a></h3>
                            <p class="box-text">PropBerries offers expert home loan support with tailored solutions to fit your needs. Enjoy competitive rates and hassle-free processing to make your dream home a reality.</p>
                            <!--<div class="service-img img-shine">-->
                            <!--    <img src="assets/img/service/1-3.png" alt="img">-->
                            <!--</div>-->
                        </div>
            ...
            <div class="row justify-content-lg-between justify-content-center align-items-center">
                <div class="col-xxl-6 col-xl-7 col-lg-6">
                    <div class="title-area text-lg-start text-center">
                        ...
                        <p class="sec-text text-white">PropBerries - Your trusted partner in seamless property management and innovative real estate solutions.</p>
                    </div>
                </div>
                <div class="col-auto">
                    <div class="sec-btn">
                        <a href="<?php echo e(config('app.baseURL')); ?>/property" class="th-btn style-border3 th-btn-icon">Browse All Project</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="swiper th-slider" id="projectSlider2" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"3"},"1200":{"slidesPerView":"3"}}}'>
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="portfolio-card style2">
                                <div class="portfolio-img img-shine" data-bs-toggle="modal">
                                    <img src="assets/img/project/life.jpg" alt="project image" style="height: 251px;">
                                    <!--<div class="portfolio-card-shape">-->
                                    <!--    <img src="assets/img/project/life.jpg" alt="img">-->
                                    <!--</div>-->
                                </div>
                                <div class="portfolio-content">
                                    <h3 class="portfolio-title"><a href="#">Life Republic</a></h3>
                                    <p class="portfolio-text">Life Republic by Kolte Patil offers a self-sustained township designed to provide a balanced, modern lifestyle amidst nature. With world-class amenities, green spaces, and a thriving community, it's the perfect place to live, work, and unwind.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="portfolio-card style2">
                                <div class="portfolio-img img-shine" data-bs-toggle="modal">
                                    <img src="assets/img/project/kasturi.jpg" alt="project image" style="height: 251px;">
                                    <!--<div class="portfolio-card-shape">-->
                                    <!--    <img src="assets/img/project/project_shape1_1.png" alt="img">-->
                                    <!--</div>-->
                                </div>
                                <div class="portfolio-content">
                                    <h3 class="portfolio-title"><a href="#">Kasturi</a></h3>
                                    <p class="portfolio-text">Kasturi offers premium homes crafted with meticulous attention to detail, blending luxury with thoughtful design. Experience modern living with state-of-the-art amenities and an unmatched level of comfort.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="portfolio-card style2">
                                <div class="portfolio-img img-shine" data-bs-toggle="modal">
                                    <img src="assets/img/project/pride.jpg" alt="project image" style="height: 251px;">
                                    <!--<div class="portfolio-card-shape">-->
                                    <!--    <img src="assets/img/project/project_shape1_1.png" alt="img">-->
                                    <!--</div>-->
                                </div>
                                <div class="portfolio-content">
                                    <h3 class="portfolio-title"><a href="#">Pride Purple</a></h3>
                                    <p class="portfolio-text">Pride Purple presents contemporary living spaces that blend elegance with innovation, offering a lifestyle of comfort and convenience. Discover premium homes with world-class amenities in vibrant, thriving communities.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="portfolio-card style2">
                                <div class="portfolio-img img-shine" data-bs-toggle="modal">
                                    <img src="assets/img/project/aishwaryam.jpg" alt="project image" style="height: 251px;">
                                    <!--<div class="portfolio-card-shape">-->
                                    <!--    <img src="assets/img/project/project_shape1_1.png" alt="img">-->
                                    <!--</div>-->
                                </div>
                                <div class="portfolio-content">
                                    <h3 class="portfolio-title"><a href="#">Aishwaryam Fashion</a></h3>
                                    <p class="portfolio-text">Aishwaryam offers thoughtfully designed homes that combine modern aesthetics with functional living spaces. Experience a lifestyle enriched with premium amenities and serene surroundings for peaceful living.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6 col-md-8 order-md-2">
                            <div class="title-area mb-md-0 text-center">
                                ...
                                <div class="btn-wrap mt-4 justify-content-center">
                                    <a href="<?php echo e(config('app.baseURL')); ?>/contact" class="th-btn mb-0 style2 th-btn-icon">Get In Touch</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 order-md-1">
                            <ul class="gallery-list-1">
                                <li class="gallery-card">
                                    <a class="popup-image" href="assets/img/gallery/aishwaryam.jpg">
                                        <img src="assets/img/gallery/aishwaryam.jpg" alt="img">
                                        <i class="fal fa-plus"></i>
                                    </a>
                                </li>
                                <li class="gallery-card">
                                    <a class="popup-image" href="assets/img/gallery/aros.jpg">
                                        <img src="assets/img/gallery/aros.jpg" alt="img">
                                        <i class="fal fa-plus"></i>
                                    </a>
                                </li>
                                <li class="gallery-card">
                                    <a class="popup-image" href="assets/img/gallery/pride.jpg">
                                        <img src="assets/img/gallery/pride.jpg" alt="img">
                                        <i class="fal fa-plus"></i>
                                    </a>
                                </li>
                            </ul>
                        ...
                        <div class="col-12 order-md-3">
                            <ul class="gallery-list-2">
                                <li class="gallery-card">
                                    <a class="popup-image" href="assets/img/gallery/aros1.png">
                                        <img src="assets/img/gallery/aros1.png" alt="img">
                                        <i class="fal fa-plus"></i>
                                    </a>
                                </li>
                                <li class="gallery-card">
                                    <a class="popup-image" href="assets/img/gallery/garden.jpg">
                                        <img src="assets/img/gallery/garden.jpg" alt="img">
                                        <i class="fal fa-plus"></i>
                                    </a>
                                </li>
                                <li class="gallery-card">
                                    <a class="popup-image" href="assets/img/gallery/atmos.jpg">
                                        <img src="assets/img/gallery/atmos.jpg" alt="img">
                                        <i class="fal fa-plus"></i>
                                    </a>
                                </li>
                            </ul>
                ...
                <div class="swiper-wrapper">
                    <div class="col-auto swiper-slide">
                        <div class="insta-box">
                            ...
                            <a target="_blank" href="../../index-3.htm" class="icon-btn"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                    </div>
                    <div class="col-auto swiper-slide">
                        <div class="insta-box">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/propberries/public_html/resources/views/index.blade.php ENDPATH**/ ?>