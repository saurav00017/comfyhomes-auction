					...
					<div class="row">
                        ...
                        <div class="form-group">
												...
												<div class="form-group">
													...
													<input class="form-control" name="property_type" required="" type="text" placeholder="Enter Property Type" value="<?php echo e($auction->property_type); ?>">
												</div>

												<div class="form-group">
													<label class="" >Property Type:</label><sup style="color: red;">*</sup>
													<input class="form-control" name="property_type_one" type="text" required=""  placeholder="Enter Property Type" value="<?php echo e($auction->property_type_one); ?>">
												</div>
