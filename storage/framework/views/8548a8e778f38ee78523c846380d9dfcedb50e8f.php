            ...
            var table = $('#data-table').DataTable({
                ...
                columns: [
...

                    {
                        ...
                        "ilter": false,
                        "mRender": function(data, type, row) {
                            return "<a class=datatable-left-link href=<?php echo e(config('app.baseURL')); ?>/admin/update-auction/" +
                                row.id +
                                "><span><button type='submit' class='btn btn-primary mr-1'>Update</button></span></a><a class=datatable-left-link href=<?php echo e(config('app.baseURL')); ?>/admin/delete-auction/" +
                                row.id +
    ...
    <script>
        $(document).on('change', '.status-toggle', function() {
            ...
            var endpoint = isActive ?
                "<?php echo e(config('app.baseURL')); ?>/admin/active-auction/" + id :
                "<?php echo e(config('app.baseURL')); ?>/admin/inactive-auction/" + id;
