                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <a href="<?php echo e(config('app.baseURL')); ?>/admin/create-auction"> <button type="submit"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $('#data-table').DataTable({
                ...
                columns: [
...

                    {
                        ...
                        "mRender": function(data, type, row) {
                            if (row.is_active == 0) {
                                return "<a class=datatable-left-link href=<?php echo e(config('app.baseURL')); ?>/admin/active-auction/" +
                                    row.id +
                                    "><span><button type='submit' class='btn btn-success'>Active</button></span></a>";

                            } else {
                                return "<a class=datatable-left-link href=<?php echo e(config('app.baseURL')); ?>/admin/inactive-auction/" +
                                    row.id +
            ...
            <div class="btn-group" role="group">
                <a href="<?php echo e(config('app.baseURL')); ?>/admin/view-auction/${row.id}" 
                   class="btn btn-info btn-sm mr-1" 
                   title="View">
                    <i class="fas fa-eye"></i>
                </a>
                <a href="<?php echo e(config('app.baseURL')); ?>/admin/update-auction/${row.id}" 
                   class="btn btn-primary btn-sm mr-1" 
                   title="Edit">
                    <i class="fas fa-edit"></i>
                </a>
                <a href="<?php echo e(config('app.baseURL')); ?>/admin/delete-auction/${row.id}" 
...
<?php echo $__env->make('admin layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\auction-comfyhomes\resources\views/admin/auction/all.blade.php ENDPATH**/ ?>