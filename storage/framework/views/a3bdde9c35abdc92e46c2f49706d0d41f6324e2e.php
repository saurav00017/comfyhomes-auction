						...
						<div class="col-lg-12 col-md-12">
							<div class="card custom-card">
								<div class="card-body">
									...
									<div>
										<a href="<?php echo e(config('app.baseURL')); ?>/admin/subscription-management" style="float: inline-end;"> <button type="submit" class="btn pull-right btn btn-primary panel-button add-btn" >Back</button></a><br>
									...
									<hr>
														...
														<form class="form-horizontal" role="form" method="POST" action="<?php echo e(config('app.baseURL')); ?>/admin/update-subscription/<?php echo e($subscription->id); ?>" enctype="multipart/form-data" >
																															<?php echo csrf_field(); ?>
										...
										<div class="col-md-12 col-lg-12 col-xl-12" style="margin-top: 14px;">
											<div class="">
												<div class="form-group">
													...
													<input class="form-control" name="days" required="" type="number" placeholder="Enter No of Days" value="<?php echo e($subscription->days); ?>">
												</div>

												<div class="form-group">
													<label class="" >Price:</label><sup style="color: red;">*</sup>
													<input class="form-control" name="price" required="" type="text" placeholder="Enter Price"value="<?php echo e($subscription->price); ?>">
												</div>

												<div class="form-group">
													<label class="" >Discont Price:</label><sup style="color: red;">*</sup>
													<input class="form-control" name="offer_price" required="" type="text" placeholder="Enter Discount Price" value="<?php echo e($subscription->offer_price); ?>">
												</div>

												<div class="form-group">
													<label class="" >Discont Percentage:</label><sup style="color: red;">*</sup>
													<input class="form-control" name="offer_percentage" required="" type="text" placeholder="Enter Discont Percentage" value="<?php echo e($subscription->offer_percentage); ?>">
												</div>
								            ...
								            <select class="form-control" name="search_engine_type" required="">
								              <option value="">Select Search Engine Type:</option>                         
												...
												<div class="form-group">
													...
													<input class="form-control" name="description" required="" type="text" placeholder="Enter Description" value="<?php echo e($subscription->description); ?>">
												</div>
...
<?php echo $__env->make('admin layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\auction-comfyhomes\resources\views/admin/subscription/edit.blade.php ENDPATH**/ ?>