...
============================== -->
    ...
    Blog Area
==============================-->
    <section class="th-blog-wrapper blog-details overflow-hidden space-top space-extra-bottom" style="background-color: #A4B5BA !important;">
        <div class="container">
            <div class="row gx-30">
                <div class="col-xxl-12 col-lg-12">
                    <div class="th-blog blog-single mb-0">
                        <div class="blog-img">
                            <img src="<?php echo e(config('app.baseURL')); ?>/storage/app/<?php echo e($blog->image); ?>" alt="Blog Image">
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a class="author" href="#"><i class="far fa-user"></i>by Propberries</a>
                                <a href="#"><i class="far fa-clock"></i><?php echo e(\Carbon\Carbon::parse($blog->created_at)->format('d F, Y')); ?></a>
                                <a href="#"><i class="far fa-house-building"></i><?php echo e($blog->type); ?></a>
                            </div>
                            <h2 class="blog-title"><?php echo e($blog->title); ?></h2>
                            <p class="blog-text"><?php echo e($blog->description); ?></p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/propberries/public_html/resources/views/blogdetails.blade.php ENDPATH**/ ?>