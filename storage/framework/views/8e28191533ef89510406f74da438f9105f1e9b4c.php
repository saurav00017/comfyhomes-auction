<style type="text/css">
    ...
    margin-bottom: 10px;
                                ...
                                <div class="col-lg-4">
                                    <div class="footer-widget">
                                        <div class="footer-logo mb-4">
                                            <a href="#"><img class="logo-bottom" src="assets/images/logo/vebsigns.png" alt="image" style="width: 170px !important;"></a>
                                        </div>
                                    ...
                                    <div class="row row-cols-md-3 row-cols-1">
                                        <div class="col">
                                            <div class="footer-widget footer-nav">
                                                ...
                                                <ul>
                                            <li>
                                                <a href="<?php echo e(config('app.baseURL')); ?>/search?id=1">IBC Auction</a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(config('app.baseURL')); ?>/search?id=2">Car Auction</a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(config('app.baseURL')); ?>/search?id=3">DRT Auction</a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(config('app.baseURL')); ?>/search?id=4">Jewellery Auction</a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(config('app.baseURL')); ?>/search?id=5">Surface Auction</a>
                                            </li>
        ...
        <!--============== Footer Section End ==============<?php /**PATH /home/comfyhomes/public_html/auction/resources/views/layouts/footer.blade.php ENDPATH**/ ?>