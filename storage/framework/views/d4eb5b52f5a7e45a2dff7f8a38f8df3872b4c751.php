...
<body>
	<div class="container-fluid">
					...
					<div class="page-header">
						<div>
							<h2 class="main-content-title tx-24 mg-b-5">Sub-Category Form</h2>
							<ol class="breadcrumb">
						...
						<div class="col-lg-12 col-md-12">
							<div class="card custom-card">
								<div class="card-body">
									...
									<div>
										<a href="<?php echo e(config('app.baseURL')); ?>/admin/sub-category-management" style="float: inline-end;"> <button type="submit" class="btn pull-right btn btn-primary panel-button add-btn" >Back</button></a><br>
									...
									<hr>
														...
														<form class="form-horizontal" role="form" method="POST" action="create-sub-category" enctype="multipart/form-data" >
																															<?php echo csrf_field(); ?>
                              ...
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
												...
												<div class="form-group">
													...
													<input class="form-control" name="subcategory" required="" type="text" placeholder="Enter Sub-Category Name">
												</div>
...
<?php echo $__env->make('admin layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\auction\resources\views/admin/subcategory/add.blade.php ENDPATH**/ ?>