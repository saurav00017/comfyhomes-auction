						...
						<div class="col-lg-12 col-md-12">
							<div class="card custom-card">
								<div class="card-body">
									...
									<div>
										<a href="<?php echo e(config('app.baseURL')); ?>/admin/category-management" style="float: inline-end;"> <button type="submit" class="btn pull-right btn btn-primary panel-button add-btn" >Back</button></a><br>
									...
									<hr>
														...
														<form class="form-horizontal" role="form" method="POST" action="<?php echo e(config('app.baseURL')); ?>/admin/update-sub-category/<?php echo e($subcategory->id); ?>" enctype="multipart/form-data" >
																															<?php echo csrf_field(); ?>
                              ...
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
												...
												<div class="form-group">
													...
													<input class="form-control" name="subcategory" required="" value="<?php echo e($subcategory->subcategory); ?>" type="text" placeholder="Enter Sub-Category Name">
												</div>
...
<?php echo $__env->make('admin layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\auction\resources\views/admin/subcategory/edit.blade.php ENDPATH**/ ?>