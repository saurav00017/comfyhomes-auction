...
.featured-thumb .starmark .fa-star{
...
<div class="starmark text-white" data-property-id="<?php echo e($propertys->id); ?>">
    <i class="far fa-star <?php echo e(in_array($propertys->id, $userWishlist) ? 'wishlist-selected' : ''); ?>" 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\auction\resources\views/search.blade.php ENDPATH**/ ?>