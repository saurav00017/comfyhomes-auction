							...
							<div class="card custom-card">
								<div class="card-body">
									...
									<hr>
														...
														<form class="form-horizontal" role="form" method="POST" action="<?php echo e(config('app.baseURL')); ?>/admin/update-category/<?php echo e($category->id); ?>" enctype="multipart/form-data" >
																															<?php echo csrf_field(); ?>
										...
										<div class="col-md-12 col-lg-12 col-xl-12" style="margin-top: 14px;">
											<div class="">
												<div class="form-group">
													...
													<input class="form-control" name="name" required="" type="text" placeholder="Enter Category Name" value="<?php echo e($category->name); ?>">
												</div>
...
<?php echo $__env->make('admin layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\auction\resources\views/admin/category/edit.blade.php ENDPATH**/ ?>