...
<head>
    ...
    <style type="text/css">
       ...
       .btn-primary:hover {
         color: #fff;
         background-color: #A4B5BA!important;
         border-color: #A4B5BA!important;
       } 
        ...
        .welcome-section-02 {
            background-image: url("<?php echo e(config('app.baseURL')); ?>/assets/images/property_inner_2.jpg");
...
<!--                             <img src="<?php echo e(config('app.baseURL')); ?>/assets/images/property_inner_2.jpg" class="header-brand-img desktop-logo" alt="House Image" style="height: 675px; width: 1000px;">
 -->                        </div>
                        <div class="col-6" style="margin-top: 95px;">
                            <div class="card" style="height: 500px; border-radius: 35px; width: 500px;">
                                <div class="text-center">
                                    <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/propberries.jpeg" class="header-brand-img desktop-logo" alt="Splash Logo" style="height: 100px; margin: 12px auto;">
                                </div>
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" placeholder="Username/Email Address" autofocus>
...
<?php /**PATH /home/propberries/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>