...
$(document).ready( function () {
    var table = $('#data-table').DataTable({
        ...
        serverSide: true,
        order: [[0, 'desc']],
        ajax: "<?php echo e(config('app.baseURL')); ?>/admin/visitor-management-allData",
        columns: [
...
<?php echo $__env->make('admin layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/propberries/public_html/resources/views/admin/visitors.blade.php ENDPATH**/ ?>