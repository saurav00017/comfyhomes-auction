...
<body>
	<div class="container-fluid">
					...
					<div class="page-header">
						<div>
							<h2 class="main-content-title tx-24 mg-b-5">Category Form</h2>
							<ol class="breadcrumb">
							...
							<div class="card custom-card">
								<div class="card-body">
									...
									<hr>
														...
														<form class="form-horizontal" role="form" method="POST" action="create-category" enctype="multipart/form-data" >
																															<?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\auction\resources\views/admin/category/add.blade.php ENDPATH**/ ?>