...
<div id="content" class="site-content">
                ...
                <div class="container">
                    ...
                    <div class="realestate-navigation-nav  d-none d-lg-block">
                        <ul class="realestate-navigation-nav-menus">
                            <li><a href="<?php echo e(url ('/')); ?>">Home</i></a>
                            ...
                            <li><a href="<?php echo e(url('premium')); ?>">Sevices</a>
        ...
        <?php /**PATH D:\auction-comfyhomes\resources\views/layouts/header.blade.php ENDPATH**/ ?>